...
class ScheduleServiceTest {
    ...
    void testGetAllSchedules() {
        ...
        List<ScheduleDto> schedules = service.getAllSchedules().getBody();
    ...
    void testGetCurrentSchedule() {
        ...
        ScheduleDto currentSchedule = service.getCurrentSchedule().getBody();
    ...
    void testGetScheduleById() {
        ...
        ScheduleDto foundSchedule = service.getScheduleById(schedule.getId()).getBody();
